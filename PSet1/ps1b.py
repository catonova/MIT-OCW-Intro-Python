...
def get_months(current_savings, r, annual_salary, portion_saved, total_cost, portion_down_payment, semi_annual_raise):
    num_months = 0
...
if __name__ == '__main__':
    ...
    r = 0.04
    current_savings = 0
    months_to_save = get_months(current_savings, r, annual_salary, portion_saved, total_cost, portion_down_payment, semi_annual_raise)
